...
<section style={styles.hero}>
    ...
    <nav style={styles.nav}>
      <div style={styles.brand}>
        <IotaLogo />
        <span className="brandText">trade.iota</span>
      </div>
      <div style={styles.navLinks}>
        <a href="https://iotanames.com" style={styles.navLink}>IOTA Names</a>
        <a href="https://www.tradeport.xyz" style={styles.navLink}>TradePort</a>
      </div>
    </nav>
